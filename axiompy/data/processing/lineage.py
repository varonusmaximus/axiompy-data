...
from .adapters.lineage_trackers import PandasLineageTracker, SparkLineageTracker  # noqa: E402
...
class LineageTrackerFactory:
    ...
    def create(
        ...
        return tracker_class(storage, settings, signal_sink)
    ...
    def create_auto(
        ...
        return cls.create(engine, storage, settings, signal_sink)
