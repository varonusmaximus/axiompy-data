...
|----------|------|---------|
| [`python-ci.yml`](python-ci.yml) | Push/PR to `main` or `develop`, or **workflow_dispatch** | **Ruff** (lint + format on Python 3.12), **pytest + coverage** on **Python 3.12** (80% gate), **Bandit** + **pip-audit** |
